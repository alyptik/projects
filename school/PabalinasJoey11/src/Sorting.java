/**
 * Five sorting methods that sort Integers
 * entered on the command line.
 * You can use the methods in Sorting.java
 * to sort an array of any class
 * as long as the class implements interface Comparable.
 * Classes such as String, Double, Fraction, Name, and ThreeNames.
 *
