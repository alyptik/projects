...
public class BinarySearchTree<T extends Comparable> {
	 ...
	 * @param key the item with the key value only
	 */
	private BinaryNode<T> getNode(BinaryNode<T> node, T key) throws TreeException
	{
	...
	public void nodeInformation(T searchKey) throws TreeException
	{
		...
		// print out children
		if (leftChild == null)
			System.out.println("left child = (nil)");
		else
			System.out.println("left child = " + leftChild.toString());
		if (rightChild == null)
			System.out.println("right child = (nil)");
		else
			System.out.println("right child = " + rightChild.toString());
