...
public class BinaryNode<T> {
	 ...
	 * Constructor
	 * 
	 * @param dataParameter is the address of the object that is stored by the node
	 * @param leftChildParameter is the address of the left child
	 * @param rightChildParameter is the address of the right child
	 * @exception ListException if number of items exceeds maximum
	 */
	 ...
	 * Mutator method
	 * 
	 * @param dataParameter is the item's address
	 */
	 ...
	 * Mutator method
	 * 
	 * @param leftChildParameter is the left child's address
	 */
	 ...
	 * Mutator method
	 * 
	 * @param rightChildParameter is the right child's address
	 */
